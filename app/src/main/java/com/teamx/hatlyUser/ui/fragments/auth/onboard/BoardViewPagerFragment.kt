package com.teamx.hatlyUser.ui.fragments.auth.onboard
...
import com.teamx.hatlyUser.ui.fragments.auth.onboard.adapter.DemoCollectionAdapter
import com.teamx.hatlyUser.ui.fragments.auth.onboard.fragments.Delivery
import com.teamx.hatlyUser.ui.fragments.auth.onboard.fragments.Dishes
import com.teamx.hatlyUser.ui.fragments.auth.onboard.fragments.Restaurant
...
//            navController.navigate(R.id.action_onBoard_to_login)
            findNavController().navigate(R.id.action_onboardViewPagerFragment_to_guestFragment)
