...
@AndroidEntryPoint
class HelpSupportFragment : BaseFragment<FragmentContactusBinding, HelpSupportViewModel>(),
    DialogHelperClass.Companion.ContactUs {

    override val layoutId: Int
        get() = R.layout.fragment_contactus
    override val viewModel: Class<HelpSupportViewModel>
        get() = HelpSupportViewModel::class.java
